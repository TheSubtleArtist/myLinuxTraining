...
- [Module 4 — Networking and Host Connectivity](#module-4--networking-and-host-connectivity-1)
- [Module 5 — Files, Users, Permissions, and Process Control](#module-5--files-users-permissions-and-process-control-1)
- [Module 6 — Software, Services, and systemd](#module-6--software-services-and-systemd)
- [Module 7 — Security, Identity, and Compliance](#module-7--security-identity-and-compliance-1)
- [Module 8 — Containers and Virtualization](#module-8--containers-and-virtualization-1)
- [Module 9 — Automation, Git, Python, and AI-Assisted Administration](#module-9--automation-git-python-and-ai-assisted-administration-1)
- [Module 10 — Monitoring, Performance, and Troubleshooting](#module-10--monitoring-performance-and-troubleshooting-1)
- [4.1 Linux Internals](#41-linux-internals)
- [4.2 Kernel and Device Management](#42-kernel-and-device-management)
- [4.3 Advanced Storage](#43-advanced-storage)
- [4.4 Network Configuration](#44-network-configuration)
- [4.5 Virtualization](#45-virtualization)
- [4.6 Authentication and Identity](#46-authentication-and-identity)
- [4.7 Security Hardening](#47-security-hardening)
- [4.8 Cryptography](#48-cryptography)
- [4.9 Compliance and Audit](#49-compliance-and-audit)
- [4.10 Automation and Orchestration](#410-automation-and-orchestration)
- [4.11 Containers](#411-containers)
- [4.12 Monitoring and Performance](#412-monitoring-and-performance)
...
- [6.1 Automation Objectives](#61-automation-objectives)
- [6.2 Automation Exercise Set](#62-automation-exercise-set)
